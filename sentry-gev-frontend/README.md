...
# SENTRY ATM · God's Eye View integration

This local branch retains God's Eye View's map/provider stack and adds the
SENTRY V2 deterministic scenario as its own `SENTRY · V2 Demo` layer.
The console exposes only SENTRY V2, Live Flights and Military Flights in Data
Layers. Other layers are not registered, and the CCTV panel is removed. Older
saved views still decode; retired layer settings are ignored without rewriting
storage simply by opening the view. Run `node scripts/qa-sentry-layers.mjs`
for the read-only layer/panel and legacy-state browser regression.
Run the sibling `sentry-gev-v2/tools/run_gev_demo.ps1` launcher, then open
<http://127.0.0.1:8781/?sentry=1>. The SENTRY backend defaults to port 8782;
`SENTRY_BACKEND_URL` configures its Vite development proxy. Provider settings
remain available through the original POWER UP panel.

SENTRY demo traffic, simulation time and CV forecasts are separate from public
live flights. Detailed Accept/Modify/Reject controls open the original V2
console in another tab using the same backend session. This branch does not
ingest the live public feed into the SENTRY predictor. See the backend's
`docs/gev_integration.md` for scope, setup, units and validation.

Run `npm test`, `npm run build`, and `node scripts/qa-sentry.mjs` for integration
verification. Browser QA uses a disposable/reset local session and writes
screenshots to `.gev-logs/sentry-qa/`. Builds alone do not provide the upstream
server proxies; use the development launcher for this local demo.

Upstream README and attribution follow below.
...
![Orbital HUD, a tracked live globe, FLIR terrain — then OPEN SOURCED](https://raw.githubusercontent.com/bilawalsidhu/gods-eye-view/759652207fd1279ece97f0f19af566feb9a82146/docs/media/hero-open-source-reveal.gif)

<a href="https://www.youtube.com/@bilawalsidhu">
  <img src="https://raw.githubusercontent.com/bilawalsidhu/gods-eye-view/759652207fd1279ece97f0f19af566feb9a82146/docs/media/youtube-popular-videos.png" alt="The God's Eye View video series on YouTube" width="100%">
</a>
...
![Riding with a live aircraft in cockpit view while switching sensor modes](https://raw.githubusercontent.com/bilawalsidhu/gods-eye-view/759652207fd1279ece97f0f19af566feb9a82146/docs/media/06-cockpit-ar.gif)
...
![Moving from a full airport overhead down to close taxiway inspection with 3D flight models](https://raw.githubusercontent.com/bilawalsidhu/gods-eye-view/759652207fd1279ece97f0f19af566feb9a82146/docs/media/start-here/airport-ground-traffic-google-3d.gif)
...
![Diving into an Austin intersection with a live public camera projected into the 3D scene](https://raw.githubusercontent.com/bilawalsidhu/gods-eye-view/759652207fd1279ece97f0f19af566feb9a82146/docs/media/03-austin-cctv.gif)

5. **Track something in orbit.** Turn on **Satellites** and click the ISS — you ride along at orbital distance, orbit ring and all.

![Tracking the ISS along its orbital path as it crosses over Ukraine](https://raw.githubusercontent.com/bilawalsidhu/gods-eye-view/759652207fd1279ece97f0f19af566feb9a82146/docs/media/14-iss-over-ukraine.gif)

6. **Switch the optics.** Tap `1`–`7` — CRT, NVG, FLIR — and the whole live planet re-renders through a different sensor.

![Cycling a dense live globe through CRT, FLIR, and NVG in one continuous view](https://raw.githubusercontent.com/bilawalsidhu/gods-eye-view/759652207fd1279ece97f0f19af566feb9a82146/docs/media/01-style-sweep.gif)
...
![Jumping between live aircraft and falling straight into a cockpit view](https://raw.githubusercontent.com/bilawalsidhu/gods-eye-view/759652207fd1279ece97f0f19af566feb9a82146/docs/media/12-switch-aircraft-cockpit.gif)
...
![A live military contact ridden through Normal, NVG, and Ironbow FLIR with dense detection](https://raw.githubusercontent.com/bilawalsidhu/gods-eye-view/759652207fd1279ece97f0f19af566feb9a82146/docs/media/start-here/military-cockpit-dense-google-3d.gif)
...
![Zilker Park and Lady Bird Lake drawing onto the 3D city as persistent vector annotations, by voice](https://raw.githubusercontent.com/bilawalsidhu/gods-eye-view/759652207fd1279ece97f0f19af566feb9a82146/docs/media/01-voice-annotate-zilker.gif)

![A spoken distance measurement spanning an airport, inspected from orbit](https://raw.githubusercontent.com/bilawalsidhu/gods-eye-view/759652207fd1279ece97f0f19af566feb9a82146/docs/media/04-airport-distance.gif)
...
![The globe populating with the world's radio stations as another live layer](https://raw.githubusercontent.com/bilawalsidhu/gods-eye-view/759652207fd1279ece97f0f19af566feb9a82146/docs/media/15-global-radio-layer.gif)
...
![A reconstructed Falcon 9 ascent climbing and curving into its projected orbit](https://raw.githubusercontent.com/bilawalsidhu/gods-eye-view/759652207fd1279ece97f0f19af566feb9a82146/docs/media/08-falcon9-replay.gif)
...
![Diving into the Bahamas and revealing labeled submarine cable routes beneath the globe](https://raw.githubusercontent.com/bilawalsidhu/gods-eye-view/759652207fd1279ece97f0f19af566feb9a82146/docs/media/09-undersea-cables.gif)
...
![Resolving a selected aircraft's recent flight path into stacked 3D loops above the terrain](https://raw.githubusercontent.com/bilawalsidhu/gods-eye-view/759652207fd1279ece97f0f19af566feb9a82146/docs/media/07-helicopter-loops.gif)

*Ask the planet: a military contact's last ~24 hours of real trace history, resolved as stacked 3D loops.*

![Asking for a walking route and flying the generated path through the 3D city](https://raw.githubusercontent.com/bilawalsidhu/gods-eye-view/759652207fd1279ece97f0f19af566feb9a82146/docs/media/10-walking-route-flythrough.gif)

*"Draw the walking route… now fly it" — banked turns, eased ends, the camera leading the path like a drone shot.*

![Descending from regional context into dense rows of retired aircraft at the boneyard](https://raw.githubusercontent.com/bilawalsidhu/gods-eye-view/759652207fd1279ece97f0f19af566feb9a82146/docs/media/08-boneyard.gif)
...
![Diving from city-scale live congestion straight into an intersection's public camera](https://raw.githubusercontent.com/bilawalsidhu/gods-eye-view/759652207fd1279ece97f0f19af566feb9a82146/docs/media/05-traffic-to-cctv.gif)
...
<sub>Media note: the capture GIFs on this page show Google Photorealistic 3D Tiles and live data layers, used promotionally with in-frame attribution; they aren't licensed for standalone reuse. See [media provenance and permissions](https://raw.githubusercontent.com/bilawalsidhu/gods-eye-view/759652207fd1279ece97f0f19af566feb9a82146/docs/media/README.md); full source terms in [DATA_SOURCES.md](DATA_SOURCES.md).</sub>
...
<img src="https://raw.githubusercontent.com/bilawalsidhu/gods-eye-view/759652207fd1279ece97f0f19af566feb9a82146/docs/media/open-source-survey.png" alt="Community survey on open-sourcing God's Eye View" width="460">
